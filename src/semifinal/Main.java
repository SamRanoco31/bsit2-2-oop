...
/**
 * Main - GIVEN COMPLETE. Do NOT edit this file.
 * It is the test program for your classes.
 */
public class Main {
    ...
    // Reads a whole line and turns it into an int (-1 if not a number)
    ...
    // Reads a whole line and turns it into a double (1.0 if not a number)
